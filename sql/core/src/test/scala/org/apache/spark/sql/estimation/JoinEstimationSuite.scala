...
class JoinEstimationSuite extends QueryTest with SharedSQLContext {
  ...
  private val joinEstimationTestData1 = Seq(
    ("join_est_test1", "key1", Seq[Long](1, 1, 2, 2, 3, 3, 3)),
    ("join_est_test2", "key2", Seq[Long](5, 6)))

  /** Data for two-column tables */
  private val joinEstimationTestData2 = Seq(
    ("join_est_test3", Seq("key31", "key32"),
      Seq[(Long, Long)]((1, 9), (2, 8), (3, 7), (4, 6), (5, 5))),
    ("join_est_test4", Seq("key41", "key42"),
      Seq[(Long, Long)]((1, 3), (2, 4))))

  /** Original column stats */
  val colStatForKey1 = ColumnStat(3, Some(1L), Some(3L), 0, 8, 8)
  val colStatForKey2 = ColumnStat(2, Some(5L), Some(6L), 0, 8, 8)
  val colStatForKey31 = ColumnStat(5, Some(1L), Some(5L), 0, 8, 8)
  val colStatForKey32 = ColumnStat(5, Some(5L), Some(9L), 0, 8, 8)
  val colStatForKey41 = ColumnStat(2, Some(1L), Some(2L), 0, 8, 8)
  val colStatForKey42 = ColumnStat(2, Some(3L), Some(4L), 0, 8, 8)
  ...
  test("estimate inner join") {
    ...
    val joinedColStat = ColumnStat(3, Some(1L), Some(3L), 0, 8, 8)
  ...
  test("update column stats for join keys and non-join keys") {
    ...
    val joinedColStat = ColumnStat(2, Some(1L), Some(2L), 0, 8, 8)
  ...
  test("estimate disjoint inner join") {
    ...
    val emptyColStat = ColumnStat(0, None, None, 0, 8, 8)
