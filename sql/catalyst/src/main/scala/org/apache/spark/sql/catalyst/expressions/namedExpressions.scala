...
import org.apache.spark.sql.catalyst.plans.logical.{ColumnStat, EventTimeWatermark}
 ...
 * @param columnStat Column statistics of this attribute.
 */
case class AttributeReference(
  ...
  override def newInstance(): AttributeReference =
    AttributeReference(name, dataType, nullable, metadata)(
      qualifier = qualifier, isGenerated = isGenerated, columnStat = columnStat)
  ...
  override protected final def otherCopyArgs: Seq[AnyRef] = {
    exprId :: qualifier :: isGenerated :: columnStat :: Nil
  }
